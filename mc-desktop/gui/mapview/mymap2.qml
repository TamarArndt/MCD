...
Rectangle {
    ...
    Map {
        ...
        MapItemView{
            ...
            delegate: MapQuickItem {
                ...
                sourceItem: Image {
                    id: locationmarker
                    source: "../../res/location_marker_small.svg" // TODO path
                }
            }
        }
        ...
        MapItemView{
            ...
            delegate: MapQuickItem {
                ...
                sourceItem: Image {
                    id: locationmarker
                    source: "../../res/location_marker.svg" // TODO path
                }
            }
        }
        ...
        MapItemView{
            ...
            delegate: MapQuickItem {
                ...
                sourceItem: Image {
                    id: locationmarker
                    source: "../../res/location_marker_split.svg" // TODO path
                }
            }
        }
    ...
    function clearOnlyPathAndMarkersOfSelectedEntry() {
        ...
        // clear path
        //pathSelectedEntry.path = []
        //mymap.addMapItem(pathSelectedEntry)
        //pathSelectedEntry.path = []
        mymap.removeMapItem(pathSelectedEntry)
//        for (var i = 0; i < pathSelectedEntry.path.length; i++) {
//            console.log(i)
//            pathSelectedEntry.removeCoordinate(0)
//        }
    }
